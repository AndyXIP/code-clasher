...
def generate_random_questions(count=5, difficulty='introductory'):
    ...
    print(f"DEBUG: generate_random_questions called with count={count}, difficulty={difficulty}")
    ...
    print("DEBUG: supabase response =", response)  # or response.data / response.error
