...
BASE_URL = (
    "https://byspc9u2xa.execute-api.eu-north-1.amazonaws.com/random-questions"
)


def get_day_index(timestamp_str: str) -> int:
    """
    Computes the number of days between the provided timestamp
    (assumed to be the day start) and the current day (UTC).
...
def parse_inputs_outputs(data):
    # Parses 'inputs' and 'outputs' fields into actual lists.
